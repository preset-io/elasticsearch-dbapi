...
class TestDBAPI(unittest.TestCase):
    ...
    def test_auth(self):
        """
        DBAPI: test Elasticsearch/OpenSearch is called with user password
        """
        if self.driver_name == "odelasticsearch":
            mock_target = "opensearchpy.OpenSearch.__init__"
        else:
            mock_target = "elasticsearch.Elasticsearch.__init__"
        with patch(mock_target) as mock_client:
    ...
    def test_https(self):
        """
        DBAPI: test Elasticsearch/OpenSearch is called with https
        """
        if self.driver_name == "odelasticsearch":
            mock_target = "opensearchpy.OpenSearch.__init__"
        else:
